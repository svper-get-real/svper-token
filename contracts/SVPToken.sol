...
contract SVPToken is ERC20, Pausable {

  using SafeMath for uint256;
    
  string public name = "Svper";      //  token name
  string public symbol = "SVP";           //  token symbol
  ...
  uint256 public cap = 1000000000 * 10 ** decimals; // Max cap 1.000.000.000 token
