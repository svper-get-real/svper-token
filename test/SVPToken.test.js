...
const SVPToken = artifacts.require('SVPToken');

contract('SVPToken', function ([_, owner, recipient, anotherAccount]) {
  ...
  const MAX_TOKEN_SUPPLY = new BigNumber(1000000000 * 10 ** TOKEN_DECIMAL);



  beforeEach(async function () {
    this.token = await SVPToken.new({ from: owner });
  });
  ...
  describe('batchMint', async function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when max cap is exceeded', function () {
        const batchListAmount = [
          333333330 * 10 ** TOKEN_DECIMAL,
          333333330 * 10 ** TOKEN_DECIMAL,
          333333430 * 10 ** TOKEN_DECIMAL
        ];
    ...
    describe('when 50 recipient ', function () {
      ...
      it('should perform batch for 50 accounts that should have 100 SVP each', async function () {
    ...
    describe('when 100 recipient ', function () {
      ...
      it('should perform batch for 100 accounts that should have 100 SVP each', async function () {
